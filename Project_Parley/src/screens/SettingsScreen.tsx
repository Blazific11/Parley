    ...
    <div className="shell px-5 py-8 sm:px-8">
      <div className="mx-auto max-w-2xl space-y-6">
        ...
        <section className="card p-6">
          ...
          <p className="mt-1 text-sm text-muted">Switch between founder, investor, and casual. This changes how you appear in matches.</p>
          <div className="mt-4 grid grid-cols-3 gap-3">
            {(["founder", "investor", "casual"] as const).map((t) => {
