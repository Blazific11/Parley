...
export default function MatchScreen() {
  ...
  return (
    <div className="shell px-5 py-8 sm:px-8">
      ...
      {matches.length === 0 ? (
        <EmptyState
          title={profile?.user_type === "casual" ? "Matches are for founders and investors" : "No matches yet"}
          hint={profile?.user_type === "casual" ? "Switch to a founder or investor account to access matching." : "Publish a pitch or update your profile to start matching."}
        />
      ) : (
